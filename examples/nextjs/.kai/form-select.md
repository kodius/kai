...
`FormSelect` wraps shadcn `Select` with react-hook-form `Controller`. It supports loading state, controlled open/close, and uses `FormOption` for option items.

File location: `components/form/form-select/form-select.tsx`
